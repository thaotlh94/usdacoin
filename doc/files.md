...
* usdacoin.conf: contains configuration settings for usdacoind or usdacoin-qt
* usdacoind.pid: stores the process id of usdacoind while running
...
* debug.log: contains debug information and general logging generated by usdacoind or usdacoin-qt
