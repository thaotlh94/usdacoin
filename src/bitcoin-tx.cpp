...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s usdacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  usdacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded usdacoin transaction") + "\n" +
              "  usdacoin-tx [options] -create [commands]   " + _("Create hex-encoded usdacoin transaction") + "\n" +
              "\n";
