...
const char * const BITCOIN_CONF_FILENAME = "usdacoin.conf";
const char * const BITCOIN_PID_FILENAME = "usdacoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Usdacoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Usdacoin";
#else
    // Unix
    return pathRet / ".usdacoin";
#endif
#endif
}
