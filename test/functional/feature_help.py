...
"""Verify that starting usdacoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start usdacoin with -h for help text")
        ...
        self.log.info("Start usdacoin with -version for version information")
